...
QT_MOC_LITERAL(5, 48, 10), // "selectPort"
QT_MOC_LITERAL(6, 59, 8), // "motorMsg"
QT_MOC_LITERAL(7, 68, 12), // "std::string*"
QT_MOC_LITERAL(8, 81, 7) // "message"

    },
    "ZaberWindow\0connectToPort\0\0std::string\0"
    "portName\0selectPort\0motorMsg\0std::string*\0"
    "message"
};
...
void ZaberWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->selectPort(); break;
        case 2: _t->motorMsg((*reinterpret_cast< std::string*(*)>(_a[1]))); break;
        default: ;
        }
