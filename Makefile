...
# Template: app
# Command: /usr/bin/qmake -o Makefile thz-auto-vis.pro
#############################################################################
...
DISTDIR = /home/sark00/Projects/cpp/picoScope/thz-auto-vis/.tmp/thz-auto-vis1.0.0
LINK          = g++
LFLAGS        = -pipe -O2 -g -flto=12 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
...
Makefile: thz-auto-vis.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
